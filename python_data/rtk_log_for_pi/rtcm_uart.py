...
log_file = 'debug_' + file_time
#log_file = 'rtcm_' +  str(time_now.year) + str(time_now.month) + str(time_now.day) + '_' + str(time_now.hour) + '_' + str(time_now.minute) + '_' + str(time_now.second)
#fh = open(log_file,"wb")
'''
def recv(serial):
	while True:
...
mkpath='./' + day
mkdir(mkpath)
log_file = mkpath + '/' + 'rtcm_' + file_time + '.bin'
print log_file
